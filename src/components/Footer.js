...
import './Footer.css';
import { FaXTwitter, FaLinkedin, FaInstagram, FaEnvelope } from 'react-icons/fa6';
    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="social-media-links">
          ...
          <a href="https://instagram.com/xchip.in" target="_blank" rel="noopener noreferrer" className="social-media-link">
            <FaInstagram />
          </a>
        </div>
